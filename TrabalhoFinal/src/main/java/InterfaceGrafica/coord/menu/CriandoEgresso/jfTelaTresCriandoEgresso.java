...
public class jfTelaTresCriandoEgresso extends javax.swing.JFrame {
    private Adm admRei;
     ...
     */
    public jfTelaTresCriandoEgresso() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfTelaTresCriandoEgresso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfTelaTresCriandoEgresso().setVisible(true);
            }
        });
    }
