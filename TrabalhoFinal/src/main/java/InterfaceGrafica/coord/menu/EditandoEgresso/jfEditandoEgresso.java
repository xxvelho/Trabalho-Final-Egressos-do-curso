...
public class jfEditandoEgresso extends javax.swing.JFrame {
    private Adm admRei;
    ...
    public jfEditandoEgresso() {
        ...
        ExAlunos egressoAtual = auxEgressoList.get(chaves.getCpfEgresso());
        Contato contatos = egressoAtual.getContatos();
        //colocando na tela
        txtNome.setText(egressoAtual.getNome());
        txtCpf.setText(egressoAtual.getCpf());
        txtData.setText(egressoAtual.getData());
        
        txtEmail.setText(contatos.getEmail());
        txtTelefone.setText(contatos.getTelefone());
        txtLinkedin.setText(contatos.getLinkedin());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editando egresso");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfEditandoEgresso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfEditandoEgresso().setVisible(true);
            }
        });
    }
